# BRT Automaton
[![Build Status](https://travis-ci.com/nickolasrm-UFRRJ/BRTAutomaton.jl.svg?branch=dev/sequential)](https://travis-ci.com/nickolasrm-UFRRJ/BRTAutomaton.jl)
[![Coverage Status](https://coveralls.io/repos/github/nickolasrm-UFRRJ/BRTAutomaton.jl/badge.svg?branch=dev/sequential)](https://coveralls.io/github/nickolasrm-UFRRJ/BRTAutomaton.jl?branch=main)
